    ...
    <div class="row">
        <div class="col-sm-9">
            <div class="p-3 mb-2 bg-light text-dark">
                ...
                <a class="tx-ye" href="<?php echo base_url()?>foru">Post your question</a>
            </div>
            ...
            <div class="gram-detail">
                ...
                foreach ($productDetail as $key => $value) {
                    ...
                    echo '<h3>'. $title . '</h3>';
                    echo '<p class="viewer">'.$ava.'
                    <small>Posted by <span class="pad-right pad-left tx-ye">'.$username.'</span></small></p>';
                    echo $value['questionde'];
                }
                ?>
                <hr>
