...
<body>
<div class="container">
    <form method="post" enctype= "multipart/form-data" action="<?php echo base_url()?>inputtoeicp3/process">
        ...
        <div class="form-group">
            <label for="exampleFormControlTextarea1">Question (Mỗi câu hỏi + đáp án phải nằm trên cùng 1 dòng)</label>
