...
<div class="container main-content">
    <!-- Body -->
    <div>
        <div class="col-md-10"><h3 class="title">Grammar</h3></div>
        <div class="col-md-2"><a class="btn btn-danger" href="<?php echo base_url()?>YiZSzkTGaa/insertBlog" role="button">Thêm mới</a></div>
    </div>
    <div class="col-md-12">
            ...
            <table class="table">
                ...
                foreach ($products as $key => $value){
                    ...
                    $rowCode = '<tr class="row-detail">
                              ...
                              <td>'.$msgCode.'</td>
                              <td><a href="'.base_url().'YiZSzkTGaa/editBlog/'.$value['ID'].'">Sửa</a></td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="'.base_url().'YiZSzkTGaa/deleteBlog/'.$value['ID'].'" type="button" class="btn btn-danger">Xóa</a>
                                        </div>
                                    </div>
                                </div>
                            </div>';
