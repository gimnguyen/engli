    ...
    <div class="row">
        <div class="col-sm-9">
            <div class="worddetail">
                <h7>VOCABULARY LIST</h7>
                <?php

                    // print_r($vocapList);

                    foreach ($vocapList as $key => $value){
                        echo '<h2>'.$value['playlistname'].'</h2>';
                        echo '<p class="ratinglist">Rating:';
                        for ($i=0; $i<$value['rating']; $i++){
                            echo '<img src="'.base_url().'public/imgs/icons/heart-icon.svg" class="rateicon">';
                        }
                        for ($i=$value['rating']; $i<5; $i++){
                            echo '<img src="'.base_url().'public/imgs/icons/unheart-icon.svg" class="rateicon">';
                        }
                        echo '</p>';
                        echo '<h6 class="cicbor">'.$value['totalword'].' words</h6>';
                    }
                ?>
            ...
            <?php
                ...
                foreach ($wordpList as $key => $value){
