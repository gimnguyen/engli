...
<div class="container main-content">
    <!-- Body -->
    <div>
        <h3 class="title">Câu hỏi part 6</h3>
    </div>
    <div class="col-md-12">
        <form action="<?php echo base_url()?>inputtoeicp6/process" enctype= "multipart/form-data"   method="post" id="insert-new">
            ...
            <label for="exampleInputPassword1">Correct Answers <small>Mỗi đáp án cách nhau bằng: (), {}, " " và viết HOA</small></label>
                <textarea class="form-control" name="vtrueAns" rows="4" ></textarea>
            </div>
