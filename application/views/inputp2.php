...
<body>
<div class="container">
    <form method="post" enctype= "multipart/form-data" action="<?php echo base_url()?>inputtoeicp2/process">
        ...
        <div class="form-group">
            <label for="exampleFormControlFile1">MP3 (upload qua FTP: public/books/p2/testcode/testcodea2.mp3)</label>
        </div>
        <div class="form-group">
        <label for="exampleInputPassword1">Correct Answers <small>Mỗi đáp án cách nhau bằng: (), {}, " " và viết HOA</small></label>
            <textarea class="form-control" name="vansw" rows="5"></textarea>
        </div>
        <div class="form-group">
            <label for="exampleFormControlTextarea1">Transcript</label>
            <textarea class="form-control" name="vtran" rows="20"></textarea>
        </div>
